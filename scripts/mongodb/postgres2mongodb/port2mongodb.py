...
from henrique.main.action.port.port_entity import PortTable, PortCollection, PortDocument
...
class Port2MongoDB:
    ...
    def j_iter2mongodb(cls, j_iter, chunk_size = 100000):
        ...
        for i, j_list_chunk in enumerate(ChunkToolkit.chunk_size2chunks(j_list, chunk_size)):
            ...
            j_pair_list = [(JToolkit.j_jpaths2filtered(j, [[PortDocument.F.KEY]]),j) for j in j_list_chunk]
